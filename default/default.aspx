<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="flowershop._default" %>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                        <div class="container">
                            <a class="navbar-brand" href="#">
                                <h1 class="logo">Flower Shop <span class="clrchange">.</span></h1>
                            </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <ul>
                        <li><a href="javascript:;" class="links">India</a></li>
                ...
                <div class="col-sm-3">
                    ...
                    <ul>
                        <li><a href="tel:+92-3182386144" class="links">93**71**70</a></li>
                        <li><a href="mailto:hayaabduljabbar30@gmail.com" class="links">bejsoumya2000@gmail.com</a>
                        </li>
                        <li><a href="javascript:;" class="links">odisha-india</a></li>
                    </ul>
                    <img src="./assets/payment.png" alt="" class="paymentimg">
                </div>
            </div>
            <div class="row copy-right">
                <div class="col-sm-12">
                    <p>Created By <span class="clrchange">soumya</span> | All Rights Reserved</p>
                    <div class="topbtn">
